...
class ImageClip {
  ...
  ImageClip(this.viewDimension, this.viewClip, [this._imageDimension]) {
    if (_imageDimension != null) {
      ...
      var imgClip = Rectangle(imgViewClip.left * rInv, imgViewClip.top * rInv,
          imgViewClip.width * rInv, imgViewClip.height * rInv);
...
class UIClipImage extends UIComponent {
  ...
  bool get hasImageDimension =>
      imgWidth != null && imgHeight != null && imgWidth > 0 && imgHeight > 0;
  ...
  Rectangle _createRect(Point p1, Point p2) {
    ...
    if (imgViewWidth != null && imgViewWidth > 0 && x2 > imgViewWidth) {
      x2 = imgViewWidth;
    }
    if (imgViewHeight != null && imgViewHeight > 0 && y2 > imgViewHeight) {
      y2 = imgViewHeight;
    }
