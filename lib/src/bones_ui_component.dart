...
abstract class UIComponent extends UIEventHandler {
  ...
  DOMTreeMap<UINode> get domTreeMap =>
      _domTreeMap ??= DOMTreeMap(domGenerator)
  ...
  static final DOMTreeMap<UINode> domTreeMapDummy = DOMTreeMapDummy(
    domGenerator,
  );
      ...
      if (_parentUIComponent == null) {
        if (_parent != null) {
          ...
          if (uiParent != null) {
            ...
            var renderingUIComponent = UIComponent.parentRenderingUIComponent(
              this,
            );
  ...
  UIComponent? _resolveParentUIComponent(Object? parent) {
    ...
    var foundUIParent =
        getContentUIComponent(parent as Element) ??
      ...
      if (elementUIComponent == null) {
        if (recursive && element2 != null && element2.hasUIChildren) {
          if (parentUIComponent == null && parent.isElement) {
            parentUIComponent = _resolveNodeUIComponent(
              parent as Element,
  ...
  static UIComponent? _resolveNodeUIComponent(
    UINode node, {
    ...
    if (uiRoot != null) {
      component = uiRoot.getUIComponentByContent(
        element,
  ...
  set refreshOnNavigate(bool refresh) {
    if (refreshOnNavigate != refresh) {
      if (refresh) {
        ...
        _refreshOnNavigateListener = UINavigator.onNavigate.listen(
          (_) => this.refresh(),
        );
      } else {
        _refreshOnNavigateListener?.cancel();
  ...
  List<UIElement> getContentChildren({
    ...
    return _getContentChildrenImpl(
      _content!.children.asListViewFixed,
      <UIElement>[],
      deep,
      filter,
    );
  ...
  List<UIElement> _getContentChildrenImpl(
    List<UIElement> list,
    List<UIElement> dst,
    bool deep,
    FilterElement? filter,
  ...
  MapEntry<String, Object>? _findChildrenDeepImpl(
    ...
    while (queue.isNotEmpty) {
      ...
      final ret = _resolveElementField(
        elem,
  ...
  void refresh({bool forceRender = false, bool clearPreservedRender = false}) {
    try {
      ...
      _refreshImpl(
        ...
        clearPreservedRender: clearPreservedRender,
      );
    } finally {
  ...
  void _refreshImpl({
    required bool forceRender,
    bool clearPreservedRender = false,
  }) {
    ...
    try {
      ...
      if (rendered is Future) {
        ...
        _setRenderingZoneUIComponent(renderingZone);
          ...
          rendered.whereType<DOMNode>().any(
            (e) => e.hasFutureElement(recursive: true),
          )) {
        _setRenderingZoneUIComponent(renderingZone);
      }
      // Normal render:
  ...
  static void _scheduleCheckFinishedRendered() {
    ...
    future = _scheduleCheckFinishedRenderedFuture = Future.delayed(
      Duration(milliseconds: 300),
      _checkFinishedRendered,
    );
  ...
  List<Object> toContentElements(
    ...
    try {
      ...
      logger.error(
        'Error converting rendered to content elements: $rendered',
        e,
        s,
      );
      return <Object>[];
  ...
  static List<String>? parseAttributeValueAsStringList(
    dynamic value, [
    Pattern? delimiter,
  ]) => parseStringFromInlineList(value, delimiter ?? _valueDelimiterGeneric);

  static String parseAttributeValueAsString(
    dynamic value, [
    String? delimiter,
  ...
  Element? getFieldElementNonTyped(String? fieldName) {
    var elem = findInContentChildDeep(
      (e) => getElementFieldName(e) == fieldName,
    );
    return elem;
  }
  ...
  UIElement? getFieldElementByValue(
    String? fieldName,
    String value, {
    bool resolveUIComponents = true,
  }) => getFieldElements(fieldName).firstWhereOrNull(
    (e) =>
  ...
  MapEntry<String, Object>? _resolveElementField<V>(
    UIElement element, {
    bool resolveUIComponents = true,
  }) {
  ...
  Map<String, UIElement> getFieldsElementsMap({
    ...
    for (var elem in fieldsElements) {
      var fieldName = getElementFieldName(
        elem,
        resolveUIComponents: resolveUIComponents,
      )!;
      ...
      if (include && !ignoreFields.contains(fieldName)) {
        if (map.containsKey(fieldName)) {
          var elemValue = parseChildElementValue(
            map[fieldName],
          ...
          if (isEmptyObject(elemValue)) {
            var value = parseChildElementValue(
              elem,
              allowTextAsValue: false,
              resolveUIComponents: resolveUIComponents,
            );
  ...
  V? getFieldExtended<V>(String? fieldName, [V? def]) {
    ...
    if (fieldComponent is UIField) {
      ...
      var val = parseChildElementValue(
        fieldComponent.content,
  ...
  List<MapEntry<K, V?>> getFieldsGroupEntriesByPrefix<K, V>(
    ...
    var entries = fields.entries
        .where((e) => e.key.startsWith(groupPrefix))
        .map((e) {
  ...
  Map<K, List<V>> getFieldsGroupListByPrefix<K, V>(
    ...
    var entries = getFieldsGroupEntriesByPrefix<K, V>(
      groupPrefix,
      fields: fields,
  ...
  List<V> getFieldsGroupValuesByPrefix<V>(
    ...
    valueAs: valueAs,
    filter: filter,
  ).map((e) => e.value).whereType<V>().toList();
