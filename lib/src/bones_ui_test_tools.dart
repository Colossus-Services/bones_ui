...
void printTestToolTitle({bool showUserAgent = true}) {
...
Future<U> _initializeTestUIRootImpl<U extends UIRoot>(
  ...
  var output =
      document.querySelector('#$outputDivID') ??
      (throw StateError(
...
Future<bool> _testUISleepUntilImpl(
  FutureOr<bool> Function() ready,
  String readyTitle,
  int? timeoutMs,
  int? intervalMs,
      ...
      if (UINavigator.currentRoute == route) {
        if (parameters != null) {
          return _equalsParameters(
            parameters,
            UINavigator.currentRouteParameters,
...
Future<void> testMultipleUI(
  Map<String, FutureOr<void> Function()> testsMain, {
  bool shuffle = false,
  int? shuffleSeed,
}) async {
  ...
  group(testUIName, () {
    ...
    setUpAll(() async {
      ...
      if (spawnHybrid != null) {
        ...
        context._channel = channel = pkg_test.spawnHybridUri(
          spawnHybrid.uri,
      ...
      context._uiRoot = uiRoot = await initializeTestUIRoot(
        uiRootInstantiator,
        outputDivID: outputDivID,
        initialRenderTimeout: initialRenderTimeout,
      );
...
> {
  ...
  /// Alias to [Element.querySelector] or [UIComponent.querySelector].
  UITestChainNode<U, Element?, T> querySelectorNonTyped(
    String? selectors, {
    bool expected = false,
  }) {
    var e = element;
  ...
  selectWhereUntilTyped<O extends Element>(
    String? selectors,
    Web<O> webType,
    bool Function(Element element) test, {
    int? timeoutMs,
    ...
    bool expected = false,
      ...
      sleepUntilElement(
        ...
        mapper: mapper,
        validator: (elems) => elems.any(test),
      ).selectWhereTyped<O>(selectors, webType, test).thenChain((o) {
        if (expected) {
          var sel = selectAllTyped(
            selectors,
            webType,
          ).element.map((e) => e.simplify()).toList();
  ...
  selectFirstWhereUntilTyped<O extends Element>(
    String? selectors,
    Web<O> webType,
    bool Function(Element element) test, {
    int? timeoutMs,
    ...
    Iterable<Element> Function(List<Element> elems)? mapper,
      ...
      sleepUntilElement(
        ...
        mapper: mapper,
        validator: (elems) => elems.any(test),
      ).selectFirstWhereTyped<O>(selectors, webType, test).thenChain((o) {
        var elem = o.element;
        if (elem == null) {
          var sel = selectAllTyped(
            selectors,
...
class UITestChainRoot<U extends UIRoot>
    extends
        UITestChain<
          U,
          U,
          UITestChain<U, dynamic, dynamic, dynamic>,
          UITestChainRoot<U>
        > {
  @override
...
>
  ...
  UITestChainNode<U, E, T> firstWhere(
...
>
  ...
  Future<UITestChainNode<U, E, T>> firstWhere(
    bool Function(E element) test, {
    E Function()? orElse,
...
>
  ...
  Future<UITestChainNode<U, List<Q>, T>> querySelectorAllTyped<
    Q extends Element
  >(String? selectors, Web<Q> webType, {bool expected = false}) => thenChain(
    (o) => o.querySelectorAllTyped<Q>(selectors, webType, expected: expected),
  );
  ...
  Future<UITestChainNode<U, List<Q>, T>> selectWhereTyped<Q extends Element>(
    ...
    (o) => o.selectWhereTyped<Q>(selectors, webType, test, expected: expected),
  );
  ...
  selectWhereUntilTyped<Q extends Element>(
    String? selectors,
    Web<Q> webType,
    bool Function(Element element) test, {
    int? timeoutMs,
  ...
  selectFirstWhereUntilTyped<Q extends Element>(
    String? selectors,
    Web<Q> webType,
    bool Function(Element element) test, {
    int? timeoutMs,
    ...
    (o) => o.selectFirstWhereUntilTyped<Q>(
      selectors,
      webType,
      test,
      timeoutMs: timeoutMs,
...
extension FutureUITestChainNodeExtension<
  ...
  E,
  P extends UITestChain<U, dynamic, dynamic, dynamic>,
  T extends UITestChainNode<U, E, P>
>
    on Future<UITestChainNode<U, E, P>> {
  Future<P?> get parent => then((o) => o.parent);
  ...
  Future<UITestChainNode<U, Element?, T>> querySelectorNonTyped(
    ...
    (o) =>
        o.querySelectorNonTyped(selectors, expected: expected)
  ...
  Future<UITestChainNode<U, W?, T>> querySelectorTyped<W extends Element>(
    ...
    (o) =>
        o.querySelectorTyped<W>(selectors, webType, expected: expected)
  ...
  Future<UITestChainNode<U, List<Element>, T>> querySelectorAllNonTyped(
    ...
    (o) =>
        o.querySelectorAllNonTyped(selectors, expected: expected)
            as UITestChainNode<U, List<Element>, T>,
  );

  Future<UITestChainNode<U, List<O>, T>> querySelectorAllTyped<
    O extends Element
  >(String? selectors, Web<O> webType, {bool expected = false}) => thenChain(
    (o) =>
        o.querySelectorAllTyped<O>(selectors, webType, expected: expected)
  ...
  Future<UITestChainNode<U, W?, T>> selectTyped<W extends Element>(
    ...
    (o) =>
        o.selectTyped(selectors, webType, expected: expected)
            as UITestChainNode<U, W?, T>,
  );
  ...
  Future<UITestChainNode<U, W, T>> selectTypedExpected<W extends Element>(
    ...
    (o) =>
        o.selectTypedExpected(selectors, webType) as UITestChainNode<U, W, T>,
  );
  ...
  Future<UITestChainNode<U, List<O>, T>> selectAllTyped<O extends Element>(
    ...
    (o) =>
        o.selectAllTyped<O>(selectors, webType, expected: expected)
            as UITestChainNode<U, List<O>, T>,
  );
  ...
  Future<UITestChainNode<U, List<Element>, T>> selectWhere(
    ...
    (o) =>
        o.selectWhere(selectors, test, expected: expected)
            as UITestChainNode<U, List<Element>, T>,
  );
  ...
  Future<UITestChainNode<U, List<O>, T>> selectWhereTyped<O extends Element>(
    ...
    (o) =>
        o.selectWhereTyped<O>(selectors, webType, test, expected: expected)
            as UITestChainNode<U, List<O>, T>,
  );
  ...
  Future<UITestChainNode<U, Element?, T>> selectFirstWhere(
    ...
    (o) =>
        o.selectFirstWhere(selectors, test, expected: expected)
            as UITestChainNode<U, Element?, T>,
  );
  ...
  Future<UITestChainNode<U, O?, T>> selectFirstWhereTyped<O extends Element>(
    ...
    (o) =>
        o.selectFirstWhereTyped<O>(selectors, webType, test, expected: expected)
            as UITestChainNode<U, O?, T>,
  );
...
extension TestFutureElementExtension<E extends Element> on Future<E?> {
  ...
  Future<Element?> select(String? selectors) {
    if (selectors == null) return Future.value(null);
    return thenChain((e) => e.select(selectors));
  }
  ...
  Future<W?> selectTyped<W extends Element>(
    ...
    if (selectors == null) return Future.value(null);
    return thenChain((e) => e.selectTyped(selectors, webType));
  }
