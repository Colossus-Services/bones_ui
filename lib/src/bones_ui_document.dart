...
class UICodeHighlight extends UIComponent {
  ...
  UICodeHighlight(Element parent, this.code,
      {this.language,
      this.normalizeIdent,
      this.linkURLs = true,
      this.urlFilter,
  ...
  String _buildHTML() {
    var codeHTML = codeToHighlightHtml(code,
        language: language, normalize: normalizeIdent);

    if (linkURLs) {
      codeHTML =
          codeHTML.replaceAllMapped(RegExp(r'''(https?://[^\s"']+)'''), (m) {
